...
/* Database Helper manages the sqlite database including initial creation, updates
 * and any CRUD operations or queries
 */
...
public class DatabaseHelper extends SQLiteOpenHelper
{
	...
	/*
	 * The onCreate method is executed the first time the app is run on the device. All the tables
	 * and triggers will be create here.
	 */
	@Override
	public void onCreate(SQLiteDatabase db)
	{

		db.execSQL("CREATE TABLE " + tblTag + " (" + colTagID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + colTagDesc + " TEXT);");

		db.execSQL("CREATE TABLE " + tblLog + " (" + colLogID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + colLogDesc + " TEXT);");

		db.execSQL("CREATE TABLE " + tblInterval + " (" + colIntervalID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + colIntervalStartTime + " TEXT, "
				+ colIntervalEndTime + " TEXT, " + colIntervalLogID
				+ " INTEGER NOT NULL, FOREIGN KEY (" + colIntervalLogID + ") REFERENCES " + tblLog
				+ " (" + colLogID + "));");

		db.execSQL("CREATE TABLE " + tblLogTag + " (" + colLogTagLogID
				+ " INTEGER NOT NULL, FOREIGN KEY (" + colLogTagLogID + ") REFERENCES " + tblLog + " ("
				+ colLogID + "), " + colLogTagTagID + " INTEGER NOT NULL, FOREIGN KEY ("
				+ colLogTagTagID + ") REFERENCES " + tblTag + " (" + colTagID + "));");

		db.execSQL("CREATE TRIGGER fkIntervalIDLogID " + " BEFORE INSERT " + " ON " + tblInterval +

		" FOR EACH ROW BEGIN" + " SELECT CASE WHEN ((SELECT " + colLogID + " FROM " + tblLog
